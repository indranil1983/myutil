...
(function($) {
	...
	fn._onDataAvailable = function(objP) {
		objP = objP ? objP : {};
		//Fix by Indranil:- typing in filter was resetting the tracked changes
		var changeCache=[];
		changeCache.addedData = this.iUCData.adata;
		changeCache.deletedData=this.iUCData.ddata;
		changeCache.updatedData=this.iUCData.udata;
		//End Fix by Indranil:- typing in filter was resetting the tracked changes
		var options = this.options,
			apply = objP.apply,
			sort = objP.sort,
			data = [],
		...
		//Fix by Indranil:- typing in filter was resetting the tracked changes
		this.iUCData.adata=changeCache.addedData;
		this.iUCData.ddata=changeCache.deletedData;
		this.iUCData.udata=changeCache.updatedData;		
		//End Fix by Indranil:- typing in filter was resetting the tracked changes
