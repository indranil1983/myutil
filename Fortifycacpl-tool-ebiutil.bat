...
REM Created on 2017/11/16 11:09:42
REM ###########################################################################
...
set FPR="Fortifycacpl-tool-ebiutil.fpr"
set BUILDID="cacpl-tool-ebiutil"
set ARGFILE="Fortifycacpl-tool-ebiutil.bat.args"
set BYTECODE_ARGFILE="Fortifycacpl-tool-ebiutil.bat.bytecode.args"
set MEMORY=-Xmx14609M -Xms400M -Xss24M 
set LAUNCHERSWITCHES=""
set OLDFILENUMBER=Fortifycacpl-tool-ebiutil.bat.fileno
set FILENOMAXDIFF=10
set ENABLE_BYTECODE=false

set PROJECTROOT0="C:\proj\cac\repository\cacpl-tool-ebiutil"
...
%SOURCEANALYZER% %MEMORY% %LAUNCHERSWITCHES% -b %BUILDID%  -source 1.8 mvn -f "C:\proj\cac\repository\cacpl-tool-ebiutil\pom.xml" com.hpe.security.fortify.maven.plugin:sca-maven-plugin:translate
IF %ERRORLEVEL%==1 (
echo Sourceanalyzer failed, exiting
GOTO :FINISHED
)
